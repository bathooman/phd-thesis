...
Empirical evaluations show that such techniques significantly outperform traditional greybox fuzzers on network servers, enabling deeper exploration of protocol logic and leading to the discovery of previously unknown bugs across a range of stateful protocols.
