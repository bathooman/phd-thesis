...
\end{equation*}
%
The assertion is evaluated only after the server's preferred block size has been established by the first relevant response; in the formulation presented in Paper~\URoman{4}, this condition is implicit and is made explicit here to avoid reading the assertion before the preference is initialized.
