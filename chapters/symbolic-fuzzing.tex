...
In this work, we use fuzzing not as a  robustness testing technique, but as a vehicle for exploring executions that may violate protocol requirements encoded as runtime assertions.
The following describes how standard fuzzing infrastructure can be leveraged for this purpose without modifying the fuzzer itself.
...
Across the evaluated requirements, both fuzzing and SE independently identified the same set of nine distinct nonconformances in the tested implementations.
