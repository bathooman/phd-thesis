...
Once a set of requirements have been extracted from these specifications, they can be translated into executable assertions that are evaluated during a protocol interaction.
...
\end{equation*}
%
The assertion is evaluated only after the server's preferred block size has been established by the first relevant response; in the formulation presented in Paper~\URoman{4}, this condition is implicit and is made explicit here to avoid executing the assertion before the preference is initialized.
