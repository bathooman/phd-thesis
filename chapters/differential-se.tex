...
The evaluation uncovered nine previously unknown bugs, including deviations from the protocol specification that can lead to interoperability issues.
...
A detailed description of the experimental setup, tested implementations and versions, and the full set of discovered issues is provided in \textcolor{red}{Paper~3}, included later in this thesis.
