...
One of the witnesses indicates that, upon receiving the first \emph{ClientHello} packet with a \rfc{sequence\_number} slightly larger than $2^{44}$, Mbed TLS responds with a \emph{HelloVerifyRequest}, indicating acceptance of the packet, while wolfSSL produces no response and appears to silently discard it.
