...
\abstractdummy{
	\begin{abstract}
		...
		The evaluation demonstrates that the proposed techniques uncover numerous previously unknown bugs, specification violations, and interoperability issues, while reducing manual effort compared to existing testing methods.
	\end{abstract}
}
