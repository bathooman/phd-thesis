...
\abstractdummy{
	\begin{abstract}
		...
		The evaluation demonstrates that the proposed techniques uncover numerous previously unknown bugs, specification violations, and interoperability issues, while reducing reliance on manually constructed test cases.
	\end{abstract}
}
